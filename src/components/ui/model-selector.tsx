...
interface ModelSelectorProps extends PopoverProps {
    ...
    models: Algo[]
    onAlgoChange: (model: Algo) => void
    selectedAlgo: Algo
}

export function AlgoSelector({ models, selectedAlgo, onAlgoChange, types, ...props }: ModelSelectorProps) {
        ...
        <div className="grid gap-2">
            ...
            <Popover open={open} onOpenChange={setOpen} {...props}>
                <PopoverTrigger asChild>
                    ...
                    >
                        {selectedAlgo ? selectedAlgo.name : "Select a model..."}
                                        ...
                                        {models
                                            ...
                                            .map((algo) => (
                                                <ModelItem
                                                    key={algo.id}
                                                    algo={algo}
                                                    isSelected={selectedAlgo?.id === algo.id}
